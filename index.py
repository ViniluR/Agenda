...
class IndexUI:
  ...
  def menu_admin():
    op = st.sidebar.selectbox("Menu", ["Manter Agenda", "Manter Clientes", "Manter Serviços", "Abrir Agenda do Dia", "Reajustar Preço", "Atualizar perfil", "Solicitações"])
    ...
    if op == "Solicitações": ConfirmaUI.main()
